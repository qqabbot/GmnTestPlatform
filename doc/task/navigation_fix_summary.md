...
## 问题描述
1. **进入 case 页面报错**: `Uncaught (in promise) Error: Illegal argument` ✅ 已修复
2. **点击其它菜单报错**: `Uncaught (in promise) TypeError: Cannot read properties of null (reading 'subTree')` ✅ 已修复
3. **之前的错误**: `Cannot read properties of null (reading 'parentNode')` ✅ 已修复
